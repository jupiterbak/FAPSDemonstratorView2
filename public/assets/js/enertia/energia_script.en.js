...
(function() {
    ...
    var VEL_INTERFAZ = 600,
        radio = 250,
        radioHours = radio + 12,
        formulaRadioDesglose = (radio * 0.75) * 2,
        isOuterRadio = 0,
        demanda,
        consumoMaximo,
        consumoMinimo,
        consumoMedio,
        canvasWidth = Math.floor(0.44 * _w),
        canvasHeight = Math.floor(0.60 * _h),
    ...
    var tablaIdsOrdenados = ['axis_1', 'axis_2', 'axis_3', 'components', 'conveyor'],
        tablaIdsInfo = {
            ...
            'axis_3': {
                ...
                'nombre': 'Axis Z',
                'nombreAbrev': 'Axis Z',
                'color':'d5e6b0', //'ffea9b', //'b4dbbb', //'F5A623',
                'highlightColor': 'd5e6b0', //'c86400', //'f5cc89',
                'icon': '\\e82c'
            },
            // 'aut': {
            //     'id': 'aut',
            ...
            'components': {
                'id': 'components',
                'nombre': 'Components',
                'nombreAbrev': 'Components',
                'color': '96c139', //'c86400', //'BD10E0',
                'highlightColor': '96c139', //'c8a200', //'d712ff',
                'icon': '\\e807'
            },
            // 'car': {
            //     'id': 'car',
            ...
            'conveyor': {
                'id': 'conveyor',
                'nombre': 'Conveyor',
                'nombreAbrev': 'Conveyor',
                'color': '5d7723', //'3D4163',
                'highlightColor': '5d7723', //'003e00', //'990029', //'003e00', //'686fa9',
                'icon': '\\e804'
            }
        },
        tablaIdsConsumos = {
    ...
    var desglose = svg.append('g')
        ...
        .attr('transform', 'translate(' + (centerX + radio + 100) + ',' + (centerY - (radio * 0.75)) + ')')
        .attr('opacity', 0);
    ...
    function pintaDesglose(evt, datos) {
        ...
        var generadoras = [datos.axis_1, datos.axis_2, datos.axis_3, datos.components, datos.conveyor],
        ...
        var acumuladoInner = 0,
            ...
            h = tsDate.getHours(),
            m = tsDate.getMinutes(),
            ecoPercent = rd3(demandaHora, [datos.axis_1, datos.axis_2, datos.axis_3].sum(true)),
            path,
            i;
        ...
        bloques.each(function(d, i) {
            ...
            var that = d3.select(this)
                ...
                .each(function() {
                    ...
                    that.select('.j-MW')
                        .text(function(d) {
                            return ENUS.numberFormat(",.2f")(porcentajesDemanda[i]) + "% " + ENUS.numberFormat(",.2f")(d.datos) + "W ";
                        })
                        .transition()
                        .attr('transform', 'translate(' + safeStepCalc + ',' + 0 + ') ' + 'rotate(-45 0 0) ');
        ...
        d3.json(path, function(error, data) {
            ...
            rads.enter().append('g')
                ...
                .on('mouseenter', function(d) {
                    ...
                    tooltip_mw
                        .text(function() {
                            return ENUS.numberFormat(",.")(d.dem) + "W";
                        });
            ...
            var dLast = lastJsonData = datosJson[datosJson.length - 1],
                generadoras = [dLast.axis_1, dLast.axis_2, dLast.axis_3, dLast.conveyor, dLast.components, dLast.nuc, dLast.car, dLast.cc],
                porcentajesDemanda = calcArrayPercents(generadoras),
                demandaHora = generadoras.sum(true),
                id;
            ...
            energias.each(function(d, i) {
                ...
                that.select('.j-valor-' + id).transition()
                    .text(function() {
                        return ENUS.numberFormat(",.")(dLast[id]) + "W";
                    });
    ...
    var baseUrl = "/getAggergatedEnergyData";
